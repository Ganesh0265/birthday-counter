...
x = setInterval(function() {
  ...
  merrywrap.classList.add('step-' + step); // Add correct step class
    ...
    function openBox() {
      ...
      if (step === 3) {
        // Show the button on step 3
        const newButton = document.getElementById('newButton');
        setTimeout(() => {
          newButton.style.display = 'block'; // Make the button visible
        }, 2000); // Adjust timing to match the gift box animation
      }
    ...
    newButton.addEventListener('click', () => {
      window.location.href = 'for my love/index1.html';
    });
